...
foreign import stdcall unsafe "HsOpenGL.h gluNewQuadric" gluNewQuadric :: IO QuadricObj

foreign import stdcall unsafe "HsOpenGL.h gluDeleteQuadric" gluDeleteQuadric ::
   QuadricObj -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h gluQuadricCallback" gluQuadricCallback ::
   QuadricObj -> GLenum -> FunPtr QuadricCallback' -> IO ()

--------------------------------------------------------------------------------

foreign import stdcall unsafe "HsOpenGL.h gluQuadricNormals" gluQuadricNormals ::
   QuadricObj -> GLenum -> IO ()

foreign import stdcall unsafe "HsOpenGL.h gluQuadricTexture" gluQuadricTexture ::
   QuadricObj -> GLboolean -> IO ()

foreign import stdcall unsafe "HsOpenGL.h gluQuadricOrientation" gluQuadricOrientation ::
   QuadricObj -> GLenum -> IO ()

foreign import stdcall unsafe "HsOpenGL.h gluQuadricDrawStyle" gluQuadricDrawStyle ::
   QuadricObj -> GLenum -> IO ()

--------------------------------------------------------------------------------

foreign import stdcall safe "HsOpenGL.h gluSphere" gluSphere ::
   QuadricObj -> Radius -> Slices -> Stacks -> IO ()

foreign import stdcall safe "HsOpenGL.h gluCylinder" gluCylinder ::
  QuadricObj -> Radius -> Radius -> Height -> Slices -> Stacks -> IO ()

foreign import stdcall safe "HsOpenGL.h gluDisk" gluDisk ::
   QuadricObj -> Radius -> Radius -> Slices -> Loops -> IO ()

foreign import stdcall safe "HsOpenGL.h gluPartialDisk" gluPartialDisk ::
