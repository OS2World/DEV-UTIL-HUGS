...
static void v6477(HugsStablePtr fun1, void* unusedArg, HsPtr arg1, HsPtr arg2, HsPtr arg3, HsPtr arg4);
static void v6477(HugsStablePtr fun1, void* unusedArg, HsPtr arg1, HsPtr arg2, HsPtr arg3, HsPtr arg4)
{
...
static void hugsprim_v6477_17(HugsStackPtr);
static void hugsprim_v6477_17(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v6477,arg1);
    hugs->putAddr(thunk);
...
static void v6478(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1);
static void v6478(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord32(arg1);
...
static void hugsprim_v6478_15(HugsStackPtr);
static void hugsprim_v6478_15(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v6478,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v6479(HugsStablePtr fun1, void* unusedArg);
static void v6479(HugsStablePtr fun1, void* unusedArg)
{
    hugs->derefStablePtr4(fun1);
    if (hugs->runIO(0)) {
...
static void hugsprim_v6479_13(HugsStackPtr);
static void hugsprim_v6479_13(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v6479,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v6480(HugsStablePtr fun1, void* unusedArg, HsPtr arg1);
static void v6480(HugsStablePtr fun1, void* unusedArg, HsPtr arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putPtr(arg1);
...
static void hugsprim_v6480_11(HugsStackPtr);
static void hugsprim_v6480_11(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v6480,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v6481(HugsStablePtr fun1, void* unusedArg, HsWord8 arg1);
static void v6481(HugsStablePtr fun1, void* unusedArg, HsWord8 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord8(arg1);
...
static void hugsprim_v6481_9(HugsStackPtr);
static void hugsprim_v6481_9(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v6481,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v6482(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1);
static void v6482(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord32(arg1);
...
static void hugsprim_v6482_7(HugsStackPtr);
static void hugsprim_v6482_7(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v6482,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
