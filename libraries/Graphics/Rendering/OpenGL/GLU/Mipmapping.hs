...
foreign import stdcall unsafe "HsOpenGL.h gluScaleImage" scaleImageAux ::
...
foreign import stdcall unsafe "HsOpenGL.h gluBuild1DMipmaps" build1DMipmapsAux ::
...
foreign import stdcall unsafe "HsOpenGL.h gluBuild2DMipmaps" build2DMipmapsAux ::
