...
foreign import stdcall unsafe "HsOpenGL.h gluOrtho2D" ortho2D ::
   GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()

foreign import stdcall unsafe "HsOpenGL.h gluPerspective" perspective ::
   GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h gluLookAt" gluLookAt ::
...
foreign import stdcall unsafe "HsOpenGL.h gluPickMatrix" gluPickMatrix ::
...
foreign import stdcall unsafe "HsOpenGL.h gluProject" gluProject ::
      GLdouble -> GLdouble -> GLdouble
...
foreign import stdcall unsafe "HsOpenGL.h gluUnProject" gluUnProject ::
      GLdouble -> GLdouble -> GLdouble
   -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLint
   -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLdouble -> IO GLint
...
foreign import stdcall unsafe "dynamic" dyn_gluUnProject4 :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLdouble -> GLdouble -> GLdouble -> GLdouble -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLint -> GLclampd -> GLclampd -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLdouble -> IO GLint) ; gluUnProject4 :: (GLdouble -> GLdouble -> GLdouble -> GLdouble -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLint -> GLclampd -> GLclampd -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLdouble -> IO GLint) ; gluUnProject4 = dyn_gluUnProject4 ptr_gluUnProject4 ; ptr_gluUnProject4 :: FunPtr a ; ptr_gluUnProject4 = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GLU 1.3") ("gluUnProject4")) ; {-# NOINLINE ptr_gluUnProject4 #-}
