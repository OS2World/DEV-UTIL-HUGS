...
foreign import stdcall unsafe "HsOpenGL.h glFrontFace" glFrontFace :: GLenum -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glGetMaterialfv" glGetMaterialfvc ::
   GLenum -> GLenum -> Ptr (Color4 GLfloat) -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glMaterialfv" glMaterialfvc ::
   GLenum -> GLenum -> Ptr (Color4 GLfloat) -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glGetMaterialfv" glGetMaterialfvf ::
   GLenum -> GLenum -> Ptr GLfloat -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glMaterialfv" glMaterialff ::
   GLenum -> GLenum -> Ptr GLfloat -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glGetMaterialiv" glGetMaterialiv ::
...
foreign import stdcall unsafe "HsOpenGL.h glMaterialiv" glMaterialiv ::
   GLenum -> GLenum -> Ptr GLint -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glGetLightfv" glGetLightfvc ::
   GLenum -> GLenum -> Ptr (Color4 GLfloat) -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glLightfv" glLightfvc ::
   GLenum -> GLenum -> Ptr (Color4 GLfloat) -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glLightfv" glLightfvv ::
   GLenum -> GLenum -> Ptr (Vertex4 GLfloat) -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glGetLightfv" glGetLightfvv ::
   GLenum -> GLenum -> Ptr (Vertex4 GLfloat) -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glLightfv" glLightfvn ::
   GLenum -> GLenum -> Ptr (Normal3 GLfloat) -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glGetLightfv" glGetLightfvn ::
   GLenum -> GLenum -> Ptr (Normal3 GLfloat) -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glLightfv" glLightfv ::
   GLenum -> GLenum -> Ptr GLfloat -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glGetLightfv" glGetLightfv ::
   GLenum -> GLenum -> Ptr GLfloat -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glLightModelfv" glLightModelfv ::
...
foreign import stdcall unsafe "HsOpenGL.h glLightModeli" glLightModeli ::
   GLenum -> GLint -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glColorMaterial" glColorMaterial ::
   GLenum -> GLenum -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glShadeModel" glShadeModel :: GLenum -> IO ()
