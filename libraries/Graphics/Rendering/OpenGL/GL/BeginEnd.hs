...
foreign import stdcall unsafe "HsOpenGL.h glBegin" glBegin :: GLenum -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glEnd" glEnd :: IO ()
...
foreign import stdcall unsafe "dynamic" dyn_glPrimitiveRestartNV :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (IO ()) ; glPrimitiveRestartNV :: (IO ()) ; glPrimitiveRestartNV = dyn_glPrimitiveRestartNV ptr_glPrimitiveRestartNV ; ptr_glPrimitiveRestartNV :: FunPtr a ; ptr_glPrimitiveRestartNV = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_NV_primitive_restart") ("glPrimitiveRestartNV")) ; {-# NOINLINE ptr_glPrimitiveRestartNV #-}
...
foreign import stdcall unsafe "HsOpenGL.h glEdgeFlag" glEdgeFlag :: GLboolean -> IO ()
