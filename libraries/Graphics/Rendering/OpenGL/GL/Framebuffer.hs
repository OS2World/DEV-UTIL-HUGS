...
foreign import stdcall unsafe "HsOpenGL.h glDrawBuffer" glDrawBuffer ::
   GLenum -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glIndexMask" glIndexMask :: GLuint -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glColorMask" glColorMask ::
...
foreign import stdcall unsafe "HsOpenGL.h glDepthMask" glDepthMask :: GLboolean -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glStencilMask" glStencilMask :: GLuint -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glClear" glClear :: GLbitfield -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glClearColor" glClearColor ::
...
foreign import stdcall unsafe "HsOpenGL.h glClearIndex" glClearIndex :: GLfloat -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glClearDepth" glClearDepth :: GLclampd -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glClearStencil" glClearStencil :: GLint -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glClearAccum" glClearAccum ::
...
foreign import stdcall unsafe "HsOpenGL.h glAccum" glAccum :: GLenum -> GLfloat -> IO ()
