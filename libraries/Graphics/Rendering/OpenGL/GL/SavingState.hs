...
foreign import stdcall unsafe "HsOpenGL.h glPushAttrib"
   glPushAttrib :: GLbitfield -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glPopAttrib"
   glPopAttrib :: IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glPushClientAttrib"
   glPushClientAttrib :: GLbitfield -> IO ()

foreign import stdcall unsafe "HsOpenGL.h glPopClientAttrib"
