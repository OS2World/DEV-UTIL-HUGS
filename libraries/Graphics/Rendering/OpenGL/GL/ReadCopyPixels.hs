...
foreign import stdcall unsafe "HsOpenGL.h glReadPixels" glReadPixels ::
...
foreign import stdcall unsafe "HsOpenGL.h glReadBuffer" glReadBuffer :: GLenum -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glCopyPixels" glCopyPixels ::
