...
foreign import stdcall unsafe "HsOpenGL.h glScissor" glScissor ::
...
foreign import stdcall unsafe "dynamic" dyn_glDepthBoundsEXT :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLclampd -> GLclampd -> IO ()) ; glDepthBoundsEXT :: (GLclampd -> GLclampd -> IO ()) ; glDepthBoundsEXT = dyn_glDepthBoundsEXT ptr_glDepthBoundsEXT ; ptr_glDepthBoundsEXT :: FunPtr a ; ptr_glDepthBoundsEXT = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_EXT_depth_bounds_test") ("glDepthBoundsEXT")) ; {-# NOINLINE ptr_glDepthBoundsEXT #-}
...
foreign import stdcall unsafe "HsOpenGL.h glAlphaFunc" glAlphaFunc ::
   GLenum -> GLclampf -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glStencilFunc" glStencilFunc ::
...
foreign import stdcall unsafe "HsOpenGL.h glStencilOp" glStencilOp ::
...
foreign import stdcall unsafe "dynamic" dyn_glActiveStencilFaceEXT :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLenum -> IO ()) ; glActiveStencilFaceEXT :: (GLenum -> IO ()) ; glActiveStencilFaceEXT = dyn_glActiveStencilFaceEXT ptr_glActiveStencilFaceEXT ; ptr_glActiveStencilFaceEXT :: FunPtr a ; ptr_glActiveStencilFaceEXT = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_EXT_stencil_two_side") ("glActiveStencilFaceEXT")) ; {-# NOINLINE ptr_glActiveStencilFaceEXT #-}
...
foreign import stdcall unsafe "HsOpenGL.h glDepthFunc" glDepthFunc :: GLenum -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glBlendFunc" glBlendFunc ::
   GLenum -> GLenum -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glLogicOp" glLogicOp :: GLenum -> IO ()
