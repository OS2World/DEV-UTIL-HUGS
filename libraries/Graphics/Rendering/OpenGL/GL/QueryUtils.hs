...
foreign import stdcall unsafe "HsOpenGL.h glGetBooleanv" glGetBooleanv ::
...
foreign import stdcall unsafe "HsOpenGL.h glGetIntegerv" glGetIntegerv ::
   GLenum -> Ptr GLint -> IO ()
...
foreign import stdcall unsafe "HsOpenGL.h glGetFloatv" glGetFloatv ::
...
foreign import stdcall unsafe "HsOpenGL.h glGetDoublev" glGetDoublev ::
...
foreign import stdcall unsafe "HsOpenGL.h glGetPointerv" glGetPointerv ::
   GLenum -> Ptr (Ptr a) -> IO ()
