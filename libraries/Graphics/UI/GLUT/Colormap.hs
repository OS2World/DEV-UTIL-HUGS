...
foreign import stdcall unsafe "HsGLUT.h glutSetColor" glutSetColor ::
...
foreign import stdcall unsafe "HsGLUT.h glutGetColor" glutGetColor ::
...
foreign import stdcall unsafe "HsGLUT.h glutCopyColormap" copyColormap ::
      Window -> IO ()
