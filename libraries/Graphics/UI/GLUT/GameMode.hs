...
foreign import stdcall unsafe "HsGLUT.h glutGameModeString" glutGameModeString ::
   CString -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutEnterGameMode" glutEnterGameMode :: IO CInt
...
foreign import stdcall unsafe "HsGLUT.h glutLeaveGameMode" leaveGameMode :: IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutGameModeGet" glutGameModeGet ::
   GLenum -> IO CInt
