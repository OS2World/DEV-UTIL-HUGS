...
foreign import stdcall unsafe "HsGLUT.h glutSolidCube" solidCube
...
foreign import stdcall unsafe "HsGLUT.h glutWireCube" wireCube
   :: Height -- ^ Length of the cube sides
   -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutSolidDodecahedron" solidDodecahedron ::
   IO ()

-- | Render a wireframe dodecahedron (12-sided regular solid) centered at the
-- modeling coordinates origin with a radius of @sqrt 3@.

foreign import stdcall unsafe "HsGLUT.h glutWireDodecahedron" wireDodecahedron :: IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutWireIcosahedron" wireIcosahedron :: IO ()

-- | Render a wireframe icosahedron (20-sided regular solid) centered at the
-- modeling coordinates origin with a radius of 1.0.

foreign import stdcall unsafe "HsGLUT.h glutSolidIcosahedron" solidIcosahedron :: IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutSolidOctahedron" solidOctahedron :: IO ()

-- | Render a wireframe octahedron (8-sided regular solid) centered at the
-- modeling coordinates origin with a radius of 1.0.

foreign import stdcall unsafe "HsGLUT.h glutWireOctahedron" wireOctahedron :: IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutWireTetrahedron" wireTetrahedron :: IO ()

-- | Render a wireframe tetrahedron (4-sided regular solid) centered at the
-- modeling coordinates origin with a radius of @sqrt 3@.

foreign import stdcall unsafe "HsGLUT.h glutSolidTetrahedron" solidTetrahedron  :: IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutSolidSphere" solidSphere
...
foreign import stdcall unsafe "HsGLUT.h glutWireSphere" wireSphere
   :: Radius   -- ^ Radius of the sphere.
   -> Slices   -- ^ Number of subdivisions (slices) around the Z axis, similar
               --   to lines of longitude.
   -> Stacks   -- ^ The number of subdivisions (stacks) along the Z axis,
...
foreign import stdcall unsafe "HsGLUT.h glutSolidCone" solidCone
...
foreign import stdcall unsafe "HsGLUT.h glutWireCone" wireCone
   :: Radius   -- ^ Radius of the base of the cone.
   -> Height   -- ^ Height of the cone.
   -> Slices   -- ^ Number of subdivisions around the Z axis.
   -> Stacks   -- ^ The number of subdivisions along the Z axis.
...
foreign import stdcall unsafe "HsGLUT.h glutSolidTorus" solidTorus
...
foreign import stdcall unsafe "HsGLUT.h glutWireTorus" wireTorus
   :: Radius   -- ^ Inner radius of the torus.
   -> Radius   -- ^ Outer radius of the torus.
   -> Slices   -- ^ Number of sides for each radial section.
   -> Stacks   -- ^ Number of radial divisions for the torus.
...
foreign import stdcall unsafe "HsGLUT.h glutSolidTeapot" solidTeapot  
   :: Height -- ^ Relative size of the teapot
   -> IO ()

-- | Render a wireframe teapot.

foreign import stdcall unsafe "HsGLUT.h glutWireTeapot" wireTeapot
   :: Height -- ^ Relative size of the teapot
   -> IO ()
