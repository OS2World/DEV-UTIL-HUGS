...
foreign import stdcall unsafe "HsGLUT.h glutCreateMenu" glutCreateMenu ::
...
foreign import stdcall unsafe "HsGLUT.h glutDestroyMenu" glutDestroyMenu ::
   MenuID -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutSetMenu" glutSetMenu :: MenuID -> IO ()

foreign import stdcall unsafe "HsGLUT.h glutGetMenu" glutGetMenu :: IO MenuID
...
foreign import stdcall unsafe "HsGLUT.h glutAddMenuEntry" glutAddMenuEntry ::
   CString -> Value -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutAddSubMenu" glutAddSubMenu ::
   CString -> MenuID -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutChangeToMenuEntry" glutChangeToMenuEntry ::
...
foreign import stdcall unsafe "HsGLUT.h glutChangeToSubMenu" glutChangeToSubMenu ::
...
foreign import stdcall unsafe "HsGLUT.h glutRemoveMenuItem" glutRemoveMenuItem ::
   Item -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutAttachMenu" glutAttachMenu :: CInt -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutDetachMenu" glutDetachMenu :: CInt -> IO ()
