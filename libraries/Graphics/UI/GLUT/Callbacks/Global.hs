...
foreign import stdcall unsafe "HsGLUT.h glutMenuStatusFunc" glutMenuStatusFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutIdleFunc" glutIdleFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutTimerFunc" glutTimerFunc ::
