...
foreign import stdcall unsafe "HsGLUT.h glutDisplayFunc" glutDisplayFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutOverlayDisplayFunc" glutOverlayDisplayFunc
   :: FunPtr DisplayCallback -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutReshapeFunc" glutReshapeFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutVisibilityFunc" glutVisibilityFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutKeyboardFunc" glutKeyboardFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutKeyboardUpFunc" glutKeyboardUpFunc ::
   FunPtr KeyboardCallback' -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutSpecialFunc" glutSpecialFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutSpecialUpFunc" glutSpecialUpFunc ::
   FunPtr SpecialCallback' -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutMouseFunc" glutMouseFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutGetModifiers" glutGetModifiers :: IO CInt
...
foreign import stdcall unsafe "HsGLUT.h glutMotionFunc" glutMotionFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutPassiveMotionFunc" glutPassiveMotionFunc ::
   FunPtr MotionCallback' -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutEntryFunc" glutEntryFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutSpaceballMotionFunc" glutSpaceballMotionFunc
...
foreign import stdcall unsafe "HsGLUT.h glutSpaceballRotateFunc" glutSpaceballRotateFunc
...
foreign import stdcall unsafe "HsGLUT.h glutSpaceballButtonFunc"
...
foreign import stdcall unsafe "HsGLUT.h glutButtonBoxFunc" glutButtonBoxFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutDialsFunc" glutDialsFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutTabletMotionFunc" glutTabletMotionFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutTabletButtonFunc" glutTabletButtonFunc ::
...
foreign import stdcall unsafe "HsGLUT.h glutJoystickFunc" glutJoystickFunc ::
