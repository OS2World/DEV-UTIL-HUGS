...
foreign import stdcall unsafe "HsGLUT.h glutSetKeyRepeat" glutSetKeyRepeat ::
   CInt -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutIgnoreKeyRepeat" glutIgnoreKeyRepeat ::
   CInt -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutForceJoystickFunc" forceJoystickCallback ::
   IO ()
