...
foreign import stdcall safe "HsGLUT.h glutRemoveOverlay" glutRemoveOverlay :: IO ()

foreign import stdcall safe "HsGLUT.h glutEstablishOverlay" glutEstablishOverlay :: IO ()
...
foreign import stdcall safe "HsGLUT.h glutShowOverlay" glutShowOverlay :: IO ()

foreign import stdcall safe "HsGLUT.h glutHideOverlay" glutHideOverlay :: IO ()
...
foreign import stdcall safe "HsGLUT.h glutUseLayer" glutUseLayer :: GLenum -> IO ()
...
foreign import stdcall safe "HsGLUT.h glutPostOverlayRedisplay"
   glutPostOverlayRedisplay :: IO ()

foreign import stdcall safe "HsGLUT.h glutPostWindowOverlayRedisplay"
