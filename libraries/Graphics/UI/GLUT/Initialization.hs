...
foreign import stdcall unsafe "HsGLUT.h glutInit" glutInit ::
...
foreign import stdcall unsafe "HsGLUT.h glutInitWindowPosition" glutInitWindowPosition
   :: CInt -> CInt -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutInitWindowSize" glutInitWindowSize ::
   CInt -> CInt -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutInitDisplayMode" glutInitDisplayMode ::
   CUInt -> IO ()
...
foreign import stdcall unsafe "HsGLUT.h glutInitDisplayString" glutInitDisplayString ::
  CString -> IO ()
