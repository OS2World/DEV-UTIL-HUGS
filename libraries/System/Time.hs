{-# LINE 1 "fptools\libraries\base\System\Time.hsc" #-}
-----------------------------------------------------------------------------
{-# LINE 2 "fptools\libraries\base\System\Time.hsc" #-}
-- |
-- Module      :  System.Time
...
{-# LINE 102 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 110 "fptools\libraries\base\System\Time.hsc" #-}
import Hugs.Time ( getClockTimePrim, toCalTimePrim, toClockTimePrim )

{-# LINE 115 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 210 "fptools\libraries\base\System\Time.hsc" #-}
getClockTime = do
  (sec,usec) <- getClockTimePrim
  return (TOD (fromIntegral sec) ((fromIntegral usec) * 1000000))


{-# LINE 236 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 372 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 383 "fptools\libraries\base\System\Time.hsc" #-}
toCalendarTime =  toCalTime False

{-# LINE 389 "fptools\libraries\base\System\Time.hsc" #-}

toUTCTime :: ClockTime -> CalendarTime

{-# LINE 392 "fptools\libraries\base\System\Time.hsc" #-}
toUTCTime      =  unsafePerformIO . toCalTime True

{-# LINE 398 "fptools\libraries\base\System\Time.hsc" #-}


{-# LINE 400 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 475 "fptools\libraries\base\System\Time.hsc" #-}

toClockTime :: CalendarTime -> ClockTime

{-# LINE 478 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 526 "fptools\libraries\base\System\Time.hsc" #-}
...
{-# LINE 700 "fptools\libraries\base\System\Time.hsc" #-}
